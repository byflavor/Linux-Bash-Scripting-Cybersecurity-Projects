...
public class AESUtil {
    ...
    public static void encryptFile(String algorithm, SecretKey key, IvParameterSpec iv,
        ...
        byte[] buffer = new byte[200]; //modified by me
        int bytesRead;
    ...
    public static void main(String[] args)  throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException,
        InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
        SecretKey secretKey = generateKey(256); //256 byte
        IvParameterSpec iv = generateIv(); //initialization vector with of same size as block that is being encrypted
        String plaintext = "Hello Ms. Pandya, how are you doing today.";
        String encryption = encrypt("AES/CFB/NoPadding",plaintext,secretKey,iv);              
        String decryption = decrypt("AES/CFB/NoPadding", encryption,secretKey, iv);
